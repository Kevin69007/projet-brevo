...
> Période : 2026-04-18 → 2026-05-18 (UTC)
> Généré le : 2026-05-18 10:41 UTC

## 📊 cuspide.fr

- **Rapports reçus** : 28
- **Volume emails** : 603
- **Conformité DMARC** : 46.6% (281/603)
  - ✅ DKIM + SPF tous deux OK : 266 (44.1%)
  - ✅ DKIM seul OK (forwarding) : 11 (1.8%)
  - ✅ SPF seul OK : 4 (0.7%)
  - 🚨 DKIM + SPF tous deux FAIL : 322 (53.4%)

### Top sources d'envoi (volume)

| Source IP | Volume | Identification | DMARC PASS |
|---|---|---|---|
| `209.85.220.41` | 323 | Google / Gmail forwarder | ⚠️ 2.5% |
| `217.72.192.74` | 19 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.126.187` | 18 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.17.13` | 15 | IONOS Mail SMTP | ✅ 100.0% |
...
| `54.240.3.14` | 9 | Amazon SES (Resend / app) | ✅ 100.0% |
| `212.227.126.134` | 9 | IONOS Mail SMTP | ✅ 100.0% |

### 🚨 Alertes — émetteurs avec DMARC FAIL

| Source IP | Volume | Identification | Domaine SPF | Domaine DKIM |
|---|---|---|---|---|
| `209.85.220.41` | 315 | Google / Gmail forwarder | `gmail.com` | `—` |
...
- **Rapports reçus** : 21
- **Volume emails** : 249
- **Conformité DMARC** : 98.0% (244/249)
  - ✅ DKIM + SPF tous deux OK : 222 (89.2%)
  - ✅ DKIM seul OK (forwarding) : 22 (8.8%)
  - ✅ SPF seul OK : 0 (0.0%)
  - 🚨 DKIM + SPF tous deux FAIL : 5 (2.0%)
...
| `212.227.126.130` | 23 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.17.13` | 22 | IONOS Mail SMTP | ✅ 100.0% |
| `217.72.192.74` | 20 | IONOS Mail SMTP | ✅ 100.0% |
| `217.72.192.75` | 19 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.17.24` | 17 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.126.187` | 16 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.126.135` | 13 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.126.134` | 13 | IONOS Mail SMTP | ✅ 100.0% |
| `212.227.126.131` | 13 | IONOS Mail SMTP | ✅ 100.0% |
...
| `35.174.145.124` | 3 | Inconnu | 🚨 0.0% |

### 🚨 Alertes — émetteurs avec DMARC FAIL

| Source IP | Volume | Identification | Domaine SPF | Domaine DKIM |
|---|---|---|---|---|
| `35.174.145.124` | 3 | Inconnu | `news.cuspide.fr` | `news.cuspide.fr` |
...
- **Rapports reçus** : 20
- **Volume emails** : 144
- **Conformité DMARC** : 100.0% (144/144)
  - ✅ DKIM + SPF tous deux OK : 129 (89.6%)
  - ✅ DKIM seul OK (forwarding) : 15 (10.4%)
  - ✅ SPF seul OK : 0 (0.0%)
